...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3><strong> Input Data Keuangan | Aktiva Tidak Berwujud </strong></h3>
                    </div>
                    <div class="card-body">
                        <form id="formdk" class="forms-sample">
                            ...
                            <div class="row">
                                <div class="col-md-4 offset-1">
                                    <h6>Aktiva Tidak Berwujud</h6>
                                </div>
                                <div class="col-md-3">
                                    <input class="form-control uang" name="input" type="text" id="aktiva_tdk_berwujud">
                                </div>
                                <div class="col-md-3">
                                    <input class="form-control uang" name="input" type="text" id="aktiva_tdk_berwujud2">
                                </div>
                            </div>
                            <br/>
    ...
    @push('script')
        <script>
        $(function() {
            let local = JSON.parse(localStorage.getItem('aktivatdkberwujud'));
            console.log(local);
            let data = {};
            ...
            $('#btnNext').click(function (e) {
                ...
                localStorage.setItem('aktivatdkberwujud', JSON.stringify(data));

                window.location.href = '/input/sertifikat/aktivalain';
            ...
            $('#btnPrev').click(function (e) {
                ...
                localStorage.setItem('aktivatdkberwujud', JSON.stringify(data));
                window.location.href = '/input/sertifikat/aktivatetap';
            });
        });
        </script>
    @endpush
