                    ...
                    <div class="card-body">
                        <form id="formdk" class="forms-sample">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input class="form-control uang" name="input" type="text" id="hutang_sewa_panjang">
                                </div>
                                <div class="col-md-3">
                                    <input class="form-control uang" name="input" type="text" id="hutang_sewa_panjang2">
                                </div>
                            </div>
                            <br/>
    ...
    @push('script')
        ...
        $(function() {
            ...
            if (local != null) {
                ...
                $.ajax({
                    type: "GET",
                    url: "/sertifikat/hutangjangkapanjang/" + kopId,
