...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3><strong> Input Data Keuangan | Biaya Lain-Lain</strong></h3>
                    </div>
                    <div class="card-body">
    ...
    @push('script')
        <script>
        $(function() {
            let local = JSON.parse(localStorage.getItem('biayalain'));
            console.log(local);
            let data = {};
            ...
            if (local != null) {
                $('input[id="biaya_lain"]').val(local.biaya_lain);
                $('input[id="biaya_lain2"]').val(local.biaya_lain2);
            } else {
                $.ajax({
                    type: "GET",
                    url: "/sertifikat/biayalain/" + kopId,
            ...
            $('#btnNext').click(function (e) {
                ...
                localStorage.setItem('biayalain', JSON.stringify(data));

                window.location.href = '/edit/sertifikat/pajakpenghasilan';
